...
# Add a button in main window to open the calculator
calc_button = Button(root, text="Open Calculator", command=topwin, bg='green', fg='white', font=('Arial', 12))
